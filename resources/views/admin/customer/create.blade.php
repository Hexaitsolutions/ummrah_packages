...
<div class="row">
  <div class="col-lg-12">
    <div class="card">
      <div class="card-body">
        {!! Form::open(['route' => 'admin.customer.store', 'id'=>'content_form','files' => true, 'method' => 'POST']) !!}
        <fieldset class="mb-3" id="form_field">
         <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              {{ Form::label('user_name', __('User Name') , ['class' => 'col-form-label required']) }}

              {{ Form::text('user_name', null, ['class' => 'form-control', 'placeholder' => __('User Name'),'required'=>'']) }}
            </div>
          </div>
