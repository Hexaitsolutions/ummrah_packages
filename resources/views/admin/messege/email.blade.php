    ...
    <div class="row">
       ...
       <div class="col-lg-12">
        ...
        <div class="col-lg-12">
            ...
            <div class="form-group">
                {{ Form::label('reaply', _lang('Reply') , ['class' => 'col-form-label required']) }}

                {{ Form::textarea('reaply', null, ['class' => 'form-control', 'placeholder' =>  _lang('Reply'), 'style' => 'resize: none;', 'rows' => '3']) }}
