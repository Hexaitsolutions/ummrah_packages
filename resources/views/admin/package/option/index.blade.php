...
<div class="row page-titles">
    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            ...
            <a href=""  data-url="{{ route('admin.option.create') }}" class="btn btn-info  d-lg-block m-l-15"  id="content_managment"><i class="ti-plus"></i> Create New</a>
        </div>
    </div>
</div>
<!-- ============================================================== -->
...
<div class="card">
    <div class="card-body">
        <h4 class="card-title">Package Option</h4>
