          ...
          <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            <div class="row">
             ...
             <div class="col-md-6">
               ...
               <select name="timezone" class="form-control select" style="width: 100%">
            ...
            <div class="col-md-6">
              ...
              <select name="language" class="form-control select" style="width: 100%">
           ...
           <div class="col-md-4">
             ...
             {{ Form::label('pop_up', _lang('pop_up') , ['class' => 'col-form-label']) }}
               {{ Form::select('pop_up',['ON' => 'ON','Off'=>'Off'],  get_option('pop_up'), ['class' => 'form-control select','style'=>'width:100%' ,'data-placeholder' =>  _lang('pop_up'), 'required' => '', 'data-parsley-errors-container' => '#parsley_district_error_area']) }}
