...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset(get_option('favicon')?'storage/favicon/'.get_option('favicon'):'assets/images/favicon1.png')}}">
...
<body class="skin-default-dark fixed-layout">
   ...
   <footer class="footer">
    ...
    </script> . All rights reserved.  {{ get_option('company_name')}}
</footer>
<!-- ============================================================== -->
<!-- End footer -->
<!-- ============================================================== -->
