    ...
    <div class="contact-section section pt-100 pt-lg-80 pt-md-70 pt-sm-60 pt-xs-50 pb-70 pb-lg-50 pb-md-40 pb-sm-30 pb-xs-20">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 mb-50 d-flex justify-content-center">
                ...
                <div class="contact-form-wrap col-12">
                    <div class="contact-form">
                        <form id="content_form" action="{{ route('post_contact') }}" method="post">
                            <div class="row">
                                <div class="col-md-6 col-12 mb-30"><input class="form-control" name="name" id="name" type="text" placeholder="Name"></div>
                                <div class="col-md-6 col-12 mb-30"><input class="form-control" name="email" id="email" type="email" placeholder="Email"></div>
                                <div class="col-md-6 col-12 mb-30"><input class="form-control" name="phone" id="phone" type="text" placeholder="Phone"></div>
                                <div class="col-md-6 col-12 mb-30"><input class="form-control" name="subject" type="text" placeholder="Subject" id="subject"></div>
                                <div class="col-12 mb-30"><textarea class="form-control" name="messege" id="messege" placeholder="Message"></textarea></div>
                                <div class="col-12 text-center"><button class="btn btn-danger" type="submit" id="submit">submit</button></div>
                            </div>
                        </form>
