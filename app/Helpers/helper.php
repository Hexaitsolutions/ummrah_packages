...
// echo 'Timezone: ' . $ipdat->geoplugin_timezone; 
  ...
  function getLogo() {
	...
	if ($logo == "") {
		return '<img src="' . asset('/assets/logo.png') . '" alt="Satt Advocate" width="160px" height="60px">';
	}
	return '<img src="' . asset('/storage/logo/' . $logo) . '" alt="' . get_option('company_name') . '"  width="160px" height="60px">';
